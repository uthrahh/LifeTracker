  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <p className="mt-4 rounded-xl2 border border-accent/40 bg-accent/10 p-4 text-sm text-ink-soft">
        ...
        real privacy policy Wayfare will publish. Do not treat the text below as a binding legal document.
      </p>
      <div className="mt-6 space-y-4 text-sm text-ink-soft">
        <p>
          Wayfare stores the tasks, habits, goals, notes, and calendar data you create in order to provide the product. Data is isolated
          per account using Postgres Row Level Security — no user can read another user&apos;s data, and Wayfare staff do not access user
