-- Reference/config data every environment needs (not user data, safe for production):
-- default quotes, default categories, feature flag definitions, and the
-- productivity guide library. See supabase/seed/seed.sql for the dev-only
-- copy of the same statements kept for local `supabase db reset` workflows.
